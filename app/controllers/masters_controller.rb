class MastersController < ApplicationController
  ...
  private
    ...
    def master_params
      params.fetch(:master, {}).permit(:currency_id, :denomination, :overprint_currency_id, :overprint_denomination, :obverse, :reverse, :printer_id, :material_id, :width, :height, :printed_on)
    end
end
